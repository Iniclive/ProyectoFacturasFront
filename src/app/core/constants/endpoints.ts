...
export const ENDPOINTS = {
  ...
  FACTURA_SEND_TO_VALIDATE:`${API_URL}/api/Facturas/sendToValidate`,
  FACTURA_SEND_TO_APPROVE:`${API_URL}/api/Facturas/sendToApprove`,
  FACTURA_SEND_TO_CANCEL_VALIDATE:`${API_URL}/api/Facturas/sendToCancelValidate`,
  ...
  PRODUCTS_FILTERED: (searchString: string) => `${API_URL}/api/Product/${searchString}`,
  PRODUCTS_ID: (id: string) => `${API_URL}/api/Product/${id}`,
